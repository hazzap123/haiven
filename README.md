...
- Main room: Motion or presence sensor (MMW radar, Zigbee PIR, etc.). I use a RingCamera with motion events. So can also parse snapshots through to check if needed (works okayish)
